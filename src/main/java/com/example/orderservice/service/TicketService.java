...
public interface TicketService {
    ...
    void updateAssigner(TicketReadDTO ticket, String userEmail) throws EntityNotFoundException, KafkaException;
    ...
    void updateTicketState(TicketReadDTO ticket, String state, String userEmail) throws EntityNotFoundException, KafkaException;
}
