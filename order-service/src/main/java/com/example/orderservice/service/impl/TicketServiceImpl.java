...
public class TicketServiceImpl implements TicketService {
    ...
    @Override
    public TicketDTORead getById(Long id) throws EntityNotFoundException {
    ...
    @Override
    public List<TicketDTORead> getTicketManagerReview(String userEmail) throws EntityNotFoundException {
    ...
    @Override
    public List<TicketDTORead> getTicketEmployeeReview(String userEmail) throws EntityNotFoundException {
    ...
    @Override
    public List<TicketDTORead> getTicketEngineerReview() {
    ...
    @Transactional
    @Override
    public TicketDTORead updateAssigner(Ticket ticket, String userEmail) throws EntityNotFoundException, KafkaException {
    ...
    @Override
    public List<TicketDTORead> getTickets(Jwt token, Integer type, Boolean available) throws EntityNotFoundException {
        switch (type) {
            case 1: {
    ...
    @Transactional
    @Override
    public TicketDTORead createTicket(TicketDTOCreate ticketDTOCreate, String userEmail) throws EntityNotFoundException {
        log.info("Creating ticket {}", ticketDTOCreate);

        Ticket ticket = ticketUtil.createTicket(ticketDTOCreate, userEmail);
    ...
    @Transactional
    @Override
    public TicketDTORead updateTicket(TicketDTORead ticketDTORead, String userEmail) throws EntityNotFoundException, KafkaException {
        log.info("Updating ticket {}", ticketDTORead);

        User user = parseUserDtoToUser(userService.getByUserEmail(userEmail));
        Ticket ticket = ticketMapper.toEntity(ticketDTORead);
    ...
    @Transactional
    @Override
    public TicketDTORead updateTicketState(Ticket ticket, String state, String userEmail) throws EntityNotFoundException, KafkaException {
    ...
    private List<TicketDTORead> parseFromEntityList(List<Ticket> tickets) {
